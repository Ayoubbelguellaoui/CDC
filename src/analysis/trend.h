...
class TrendAnalyzer {
   public:
    ...
    TrendReport compare(const Baseline& baseline, const std::vector<cdc::Finding>& current);

    TrendReport compare(const std::string& baseline_file, const std::vector<cdc::Finding>& current);
